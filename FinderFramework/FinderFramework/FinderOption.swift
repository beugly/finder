...
public protocol FinderOptionProtocol_ {
    /// The vertex type
     ...
     */
    func estimatedCost(from current: Vertex, to target: Vertex) -> Int

    /**
     * Returns the actual cost to reach the indicated 'current' vertex from 'parent' vertex
     * If 'current doesn't valid, the cost returned will be nil
     */
    func cost(of current: Vertex, from parent: Vertex) -> Int?
}
